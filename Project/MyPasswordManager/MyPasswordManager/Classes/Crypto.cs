...
namespace MyPasswordManager.Classes
{
    public class Crypto
    {
        ...
        //WindowsIdentity.GetCurrent().User.AccountDomainSid.Value
        public string EncryptAES(string clearText, string encryptKey)
        {
        ...
        public string DecryptAES(string cipherText, string encryptKey)
        {
